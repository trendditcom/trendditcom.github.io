              ...
              <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                ...
                <div class="relative overflow-hidden rounded-t-xl h-56">
                  ...
                  <div class="absolute top-4 left-4">
                    <span class="px-3 py-1 bg-emerald-600/90 text-white text-sm font-medium rounded-full backdrop-blur-sm">
                ...
                <div class="p-6 flex-1 flex flex-col">
                  <h3 class="text-xl font-bold mb-3 line-clamp-2 group-hover:text-emerald-600 transition-colors leading-tight">
                    {{ post.title }}
                  </h3>
                  ...
                  <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div class="flex items-center gap-2">
                      <span class="text-emerald-600 text-sm font-medium group-hover:underline">
                        Read More →
                      </span>
                    </div>
